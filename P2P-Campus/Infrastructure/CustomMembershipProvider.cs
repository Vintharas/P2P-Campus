...
{
    /// <summary>
    /// Customized membership provider for handling authentication and authorization within the
    /// application. The bare minimun needed is to implement the ValidateUser method.
    /// </summary>
